...
<div class="projet_1_data">
  ...
  for ($i_a = 0; $i_a < count($dynamicVariables['title_projet']); $i_a++) {
    ...
    echo "<div style='$margin_info'   id='id_" . $sha1_[$i_a] . "' class='" . $sha1_[$i_a] . " section_1 hexagon colors_array_" . fmod($i_a, count($colors_array)) ." hover_cursor' onclick='function_projet_2(this)'>";
