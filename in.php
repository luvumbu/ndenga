...
if(count($dynamicVariables['nom_user'])>0){
    ...
    $_SESSION["nom_user"][0]= $dynamicVariables['nom_user'][0] ; 
$_SESSION["password_user"][1]= $dynamicVariables['password_user'][0] ; 
$_SESSION["id_user"][2]= $dynamicVariables['id_user'][0] ; 
$_SESSION["id_sha1_user"][3]= $dynamicVariables['id_sha1_user'][0] ; 
...
<?php 
    ...
    echo "Vous avez déja valide votre inscription vous pouvez maitenant vous connecter" ; 
    ?>
