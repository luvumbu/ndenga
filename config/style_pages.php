...
$databaseHandler->action_sql("INSERT INTO `style_pages` (total_style_text_pages,name_style_pages,id_user_style_page,id_sha1_style_page,total_style_pages,date_inscription_style_page,header_style_pages,total_style_parent_pages) VALUES ('$total_style_text_pages','$name_style_pages','$id_sha1_user_projet','$id_sha1_style_page','$total_style_pages','$date_inscription_projet','$header_style_pages','$total_style_parent_pages')");
